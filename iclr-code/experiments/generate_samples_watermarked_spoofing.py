...
from kg_lm_watermarking.watermark_reliability_release.watermark_processor import WatermarkLogitsProcessor
...
for model_name in tqdm(args.model_names):
    ...
    for watermark_config in tqdm(watermark_configs_list):
        if watermark_config["type"] == "aaronson":
        ...
        #samples = generate_samples(model, tokenizer, args, prompts, watermark, do_sample=do_sample)
